...
ind_dict = np.load('event_ind_O6.npy',allow_pickle=True).item()
seed_arr = []
...
#         break
    ...
    for n in range(len(lensed_index)):
        ...
        with open(f'../samples_O6/sampling_sis_GO_seed_{seed}_ind_{ind}/label_result.json', 'r') as file: 
            data = json.load(file)
    ...
    np.savetxt(f'../emcee_samples_O6/emcee_H0_Om0_seed_{seed}_samples_O6.txt',samples)
    ...
    plt.savefig(f'../plots/emcee_H0_Om0_seed_{seed}_O6.png')
